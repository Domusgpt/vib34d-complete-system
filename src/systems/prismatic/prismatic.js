...
export default function createPrismaticSystem() {
  let program, vao;
  let uniforms = {};
  ...
  function draw(gl, state, dt) {
    ...
    gl.uniform1f(uniforms.u_sat,       (p.saturation ?? 0.6));
  ...
  function dispose(gl) {
    ...
    // Program/buffers are auto-GC'd by page; delete explicitly if you prefer
